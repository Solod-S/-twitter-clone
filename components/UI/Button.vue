...
{
  /* <UIButton size="sm">Tweet</UIButton>  for size props*/
}
...
// <UIButton liquid>Tweet</UIButton> (if liquid tru then w-full, else w-min)
const classes = computed(
  () => `${paddingClases.value} ${props.liquid ? "w-full" : defaultWidth.value}`
);
